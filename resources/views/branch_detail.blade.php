                    ...
                    <div id="all">
                        ...
                        <form action="{{route('branch_detail.post')}}" method="post">
                            ...
                            <table style="width: 50%; float:left">
                                <tr>
                                    <td>Company</td>
                                    <td><input type="text" style="width: 80px;color: gray" value="{{$branch->cpn_code}}" name="cpn_code" readonly>
                                ...
                                <tr>
                                    <td>Area</td>
                                    <td><input style="width: 300px" type="text" value="{{$branch->br_area}}" name="area" required></td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                                ...
                                <tr>
                                    ...
                                    <td><select  name="status">
                                            <option selected disabled hidden>{{$branch->br_status}}</option>
