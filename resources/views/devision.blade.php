                        ...
                        <form action="{{route('devision_search.get')}}" method="get">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input style="width: 100px" type="text" placeholder="Branch code" name="br_code">
                                        <input type="text" placeholder="Please enter Branch name" name="br_name"></td>
                                </tr>
                                <tr>
                                    <td>Devision</td>
                                    <td><input style="width: 100px" type="text" placeholder="Devison code" name="code">
                                        <input type="text" placeholder="Please enter Devision name" name="name"></td>
                                </tr>
                                <tr>
                                    <td>Email</td>
                            ...
                            <div id="body_button">
                                <a href="{{route('devision_register.get')}}" style="text-decoration: none;    margin-left: 10px;">
